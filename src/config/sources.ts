...
export const SOURCES: Source[] = [
  ...
  // ------------------------------------------------------- dev tool releases
  { id: "halmos", name: "Halmos", type: "release", owner: "a16z", repo: "halmos", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "ape", name: "Ape", type: "release", owner: "ApeWorX", repo: "ape", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "equivm", name: "EquiVM", type: "release", owner: "argotorg", repo: "EquiVM", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "fe", name: "Fe", type: "release", owner: "argotorg", repo: "fe", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "hevm", name: "hevm", type: "release", owner: "argotorg", repo: "hevm", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "revm", name: "Revm", type: "release", owner: "bluealloy", repo: "revm", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "evmole", name: "EVMole", type: "release", owner: "cdump", repo: "evmole", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "echidna", name: "Echidna", type: "release", owner: "crytic", repo: "echidna", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "slither", name: "Slither", type: "release", owner: "crytic", repo: "slither", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "solc-select", name: "solc-select", type: "release", owner: "crytic", repo: "solc-select", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "mythril", name: "Mythril", type: "release", owner: "ConsenSysDiligence", repo: "mythril", category: "developers", trust: "auto", kind: "developer tool" },
  ...
  { id: "headlong", name: "Headlong", type: "release", owner: "esaulpaugh", repo: "headlong", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "ethers-js", name: "Ethers.js", type: "release", owner: "ethers-io", repo: "ethers.js", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "ethereumjs-monorepo", name: "EthereumJS Monorepo", type: "release", owner: "ethereumjs", repo: "ethereumjs-monorepo", category: "developers", trust: "auto", kind: "developer tool", tagFilter: /^@ethereumjs\/vm@/ },
  ...
  { id: "voltaire", name: "Voltaire", type: "release", owner: "evmts", repo: "voltaire", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "forge-std", name: "Forge Std", type: "release", owner: "foundry-rs", repo: "forge-std", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "foundry", name: "Foundry", type: "release", owner: "foundry-rs", repo: "foundry", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "solidity-bytes-utils", name: "Solidity Bytes Utils", type: "release", owner: "GNSPS", repo: "solidity-bytes-utils", category: "developers", trust: "auto", kind: "developer tool" },
  ...
  { id: "circom", name: "Circom", type: "release", owner: "iden3", repo: "circom", category: "developers", trust: "auto", kind: "developer tool" },
  ...
  { id: "heimdall", name: "Heimdall", type: "release", owner: "Jon-Becker", repo: "heimdall-rs", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "nethereum", name: "Nethereum", type: "release", owner: "Nethereum", repo: "Nethereum", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "hardhat", name: "Hardhat", type: "release", owner: "NomicFoundation", repo: "hardhat", category: "developers", trust: "auto", kind: "developer tool", tagFilter: /^hardhat@/ },
  { id: "solx", name: "solx", type: "release", owner: "NomicFoundation", repo: "solx", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "openzeppelin-contracts", name: "OpenZeppelin Contracts", type: "release", owner: "OpenZeppelin", repo: "openzeppelin-contracts", category: "developers", trust: "auto", kind: "developer tool" },
  ...
  { id: "solar", name: "Solar", type: "release", owner: "paradigmxyz", repo: "solar", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "plank", name: "Plank", type: "release", owner: "plankevm", repo: "plank-monorepo", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "micro-eth-signer", name: "micro-eth-signer", type: "release", owner: "paulmillr", repo: "micro-eth-signer", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "noble-ciphers", name: "noble-ciphers", type: "release", owner: "paulmillr", repo: "noble-ciphers", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "snekmate", name: "Snekmate", type: "release", owner: "pcaversaccio", repo: "snekmate", category: "developers", trust: "auto", kind: "developer tool" },
  ...
  { id: "solhint", name: "Solhint", type: "release", owner: "protofire", repo: "solhint", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "semaphore", name: "Semaphore", type: "release", owner: "semaphore-protocol", repo: "semaphore", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "solidity", name: "Solidity", type: "release", owner: "ethereum", repo: "solidity", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "sourcify", name: "Sourcify", type: "release", owner: "ethereum", repo: "sourcify", category: "developers", trust: "auto", kind: "developer tool", tagFilter: /^sourcify-server@/ },
  { id: "blst", name: "BLST", type: "release", owner: "supranational", repo: "blst", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "slither-mcp", name: "Slither MCP", type: "release", owner: "trailofbits", repo: "slither-mcp", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "zerokit", name: "ZeroKit", type: "release", owner: "vacp2p", repo: "zerokit", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "solady", name: "Solady", type: "release", owner: "Vectorized", repo: "solady", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "vyper", name: "Vyper", type: "release", owner: "vyperlang", repo: "vyper", category: "developers", trust: "auto", kind: "developer tool" },
  { id: "viem", name: "Viem", type: "release", owner: "wevm", repo: "viem", category: "developers", trust: "auto", kind: "developer tool", tagFilter: /^viem@/ },
  { id: "wagmi", name: "Wagmi", type: "release", owner: "wevm", repo: "wagmi", category: "developers", trust: "auto", kind: "developer tool", tagFilter: /^wagmi@/ },
